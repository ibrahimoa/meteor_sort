...
def trainCNN():
    ...
    model = tf.keras.models.Sequential([
        Conv2D(12, (7, 7), activation='elu', input_shape=ImageResolutionGrayScale, strides=1, kernel_constraint=unit_norm()),
        ...
        Conv2D(24, (2, 2), activation='elu', kernel_initializer='he_uniform', kernel_constraint=unit_norm()),
        Conv2D(32, (2, 2), activation='elu', kernel_initializer='he_uniform', kernel_constraint=unit_norm()),
        MaxPooling2D(pool_size=(2, 2)),
        BatchNormalization(),

        Flatten(),
        Dense(288, activation='elu', kernel_initializer='he_uniform', kernel_constraint=unit_norm()),
        BatchNormalization(),
