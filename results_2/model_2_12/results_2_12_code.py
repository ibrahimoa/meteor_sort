...
def trainCNN():
    ...
    model = tf.keras.models.Sequential([
        Conv2D(12, (7, 7), activation='elu', input_shape=ImageResolutionGrayScale, strides=1, kernel_regularizer=l2(l=0.01)),
        Conv2D(16, (7, 7), activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        MaxPooling2D(pool_size=(2, 2)),
        BatchNormalization(),

        Conv2D(16, (5, 5), activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        Conv2D(24, (5, 5), activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        MaxPooling2D(pool_size=(2, 2)),
        BatchNormalization(),

        Conv2D(16, (3, 3), activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        Conv2D(24, (3, 3), activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        MaxPooling2D(pool_size=(2, 2)),
        BatchNormalization(),
        ...
        Conv2D(24, (2, 2), activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        Conv2D(32, (2, 2), activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        MaxPooling2D(pool_size=(2, 2)),
        BatchNormalization(),

        Flatten(),
        Dense(288, activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        BatchNormalization(),
        Dense(16, activation='elu', kernel_initializer='he_uniform', kernel_regularizer=l2(l=0.01)),
        BatchNormalization(),
