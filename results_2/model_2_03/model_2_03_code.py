...
def trainCNN( ):
    ...
    model = tf.keras.models.Sequential([
        Conv2D(16, (7, 7), activation='relu', input_shape=ImageResolutionGrayScale, strides=1),
        Conv2D(16, (7, 7), activation='relu', input_shape=ImageResolutionGrayScale, strides=1),
        MaxPooling2D(pool_size=(2, 2)),
        Dropout(0.30),

        Conv2D(12, (5, 5), activation='relu', kernel_initializer='he_uniform'),
        Conv2D(24, (5, 5), activation='relu', kernel_initializer='he_uniform'),
        Conv2D(12, (5, 5), activation='relu', kernel_initializer='he_uniform'),
        MaxPooling2D(pool_size=(2, 2)),
        Dropout(0.30),
        ...
        Flatten(),
        Dense(864, activation='relu', kernel_initializer='he_uniform'),
        Dropout(0.30),
